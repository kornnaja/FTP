<?php 
    ...
    class DB_con {
        ...
        public function insert($username, $email, $password, $mem_fname, $mem_lname, $mem_tel, $mem_born) {
        ...
        public function update($username, $email, $password, $mem_fname, $mem_lname, $mem_tel, $mem_born, $userid) {
            $result = mysqli_query($this->dbcon, "UPDATE user SET 
                $username = 'username',
                $email = 'email',
                $password = 'password_1',
                $mem_fname = 'member_firstname',
                $mem_lname = 'member_lastname',
                $mem_tel = 'member_tel',
                $mem_born = 'member_born'
                WHERE id = '$userid'
            ");
            return $result;
        }
