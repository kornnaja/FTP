                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu metismenu">
                            ...
                            <li>
                                ...
                                <a href="member-site-own-edit.php?id=<?php $userid ?>">
                                    <i class="metismenu-icon pe-7s-display2"></i>
                                    แก้ไขข้อมูลส่วนตัว
                                </a>
                            </li>
                            ...
                            <div class="content">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="container">
                                        ...
                                        <hr>
                                        <table id="mytable" class="mb-0 table table-dark">
                                            <h3 class="mt-5">ข้อมูลสมาชิก</h3>
                                            <hr>
                                            <thead>
                                                <th>#</th>
                                                <th>Username</th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="member-site-own-edit.php?id=<?php echo $row['id']; ?>" class="mb-2 mr-2 btn btn-primary">Edit</a></td>
