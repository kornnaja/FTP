...
if (isset($_POST['submit'])) {
    ...
    if (!$upload) {
        echo ("<script LANGUAGE='JavaScript'>
            window.alert('อัพโหลดล้มเหลว');
            window.location.href='admin-site-ftp.php';
            </script>");
        exit();
    } else {
        echo ("<script LANGUAGE='JavaScript'>
            window.alert('อัพโหลดสำเร็จ');
                ...
                <div class="scrollbar-sidebar ps">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu metismenu">
                            ...
                            <li>
                                <a href="admin-site-work.php">
                                    <i class="metismenu-icon pe-7s-display2"></i>
                                    ข้อมูลสมาชิก
                                </a>
                            </li>
                            <li>
                                <a href="admin-site-ftp.php">
                                    <i class="metismenu-icon pe-7s-display2"></i>
                                    ข้อมูลการฝากไฟล์
                                </a>
                            </li>
                        ...
                        <div class="col-12">
                            ...
                            <div class="content">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="container">
                                        <h1 class="mt-5">ระบบฝากไฟล์</h1>
                                        <h1>----------------------------------------------------</h1>
                                        <h1>FTP Service</h1>
                                        <br>
                                        <a href="admin-site-ftp-list.php" class="mb-2 mr-2 btn btn-primary btn-block">รายละเอียดข้อมูลที่เก็บไว้</a>
                                        <hr>
                                        <div class="card-body">
                                        <h2>Upload File</h2>
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <input class="mb-2 mr-2 btn-transition btn btn-outline-secondary" type="file" name="file" id="file">
                                            <button class="mb-2 mr-2 btn btn-secondary" type="submit" name="submit">upload</button>
                                        </form>
                                        <br>
                                            <!-- <div>
                                                <h3>Create Folder</h3>
                                        ...
                                        <hr>
                                        <h2 class="mb-2 mr-2 btn-transition btn btn-outline-danger">หมายเหตุ : กรุณาฝากไฟล์ขนาดเล็กๆ เช่น เอกสาร และรูปภาพเท่านั้น</h2>
