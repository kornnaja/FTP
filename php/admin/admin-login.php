                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Admin Login Site
                                    <div class="page-title-subheading">สำหรับลงชื่อเข้าใช้แอดมิน</div>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="form-content">
                                        <form method="POST" action="login_db.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="password" name="password" required="required" placeholder="Enter text">
                                            </div>
                                            <div class="form-group">
