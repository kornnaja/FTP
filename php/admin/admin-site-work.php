                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="admin-site-edit.php?id=<?php echo $row['id']; ?>" class="mb-2 mr-2 btn btn-primary">Edit</a></td>
                                                        <td><a href="admin-site-delete.php?del=<?php echo $row['id']; ?>" class="mb-2 mr-2 btn btn-danger">Delete</a></td>
                                                    </tr>
